...
symlink = "/etc/bind/aracdn.com-lisboa-symlink"
file1 = "/etc/bind/aracdn.com-lisboa.db"
file2 = "/etc/bind/aracdn.com-lisboa2.db"
...
ROUTER_IPS = ['192.100.1.130', '192.100.1.131']
